...
- 198 / 198 tests green (132 main + 66 PEB Phases 1-4).
...
| — | PEB submodule (`reaction_diffusion_peb/`) — Phases 1-4 done, 5-11 planned | in progress | [docs/peb_submodule](./docs/peb_submodule.md) |
